// lightningcss@1.19.0
import type { Angle, CssColor, CustomProperty, Declaration, DeclarationBlock, EnvironmentVariable, Function, Image, LengthValue, MediaQuery, Multiplier, ParsedComponent, Ratio, Resolution, Rule, Selector, StyleRule, SupportsCondition, Time, Token, TokenOrValue, UnknownAtRule, Url, Variable } from './ast'
